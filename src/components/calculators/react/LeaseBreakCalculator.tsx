	...
	return (
		<div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
			...
			<div className="grid gap-6">
				...
				<div className="rounded-[1.5rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-6 shadow-sm">
					<div className="flex items-center gap-2 mb-4">
						<span className="flex h-6 w-6 items-center justify-center rounded-full bg-cyan-100 dark:bg-cyan-950 text-xs font-bold text-cyan-600 dark:text-cyan-400">1</span>
						<h3 className="text-lg font-bold text-slate-800 dark:text-white">Base Rent Details</h3>
					</div>
					...
					<div className="mt-4 flex items-center justify-between rounded-[1rem] bg-slate-50 dark:bg-slate-950/40 p-4 border border-slate-100 dark:border-slate-850">
						<span className="text-sm font-medium text-slate-500">Remaining Lease Value:</span>
						<span className="text-base font-bold text-slate-800 dark:text-white">{formatCurrency(remainingLeaseValue)}</span>
					</div>
				</div>
				...
				<div className="rounded-[1.5rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-6 shadow-sm">
					<div className="flex items-center gap-2 mb-4">
						<span className="flex h-6 w-6 items-center justify-center rounded-full bg-cyan-100 dark:bg-cyan-950 text-xs font-bold text-cyan-600 dark:text-cyan-400">2</span>
						<h3 className="text-lg font-bold text-slate-800 dark:text-white">Lease Break Penalty</h3>
					</div>
				...
				<div className="rounded-[1.5rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 p-6 shadow-sm">
					<div className="flex items-center gap-2 mb-4">
						<span className="flex h-6 w-6 items-center justify-center rounded-full bg-cyan-100 dark:bg-cyan-950 text-xs font-bold text-cyan-600 dark:text-cyan-400">3</span>
						<h3 className="text-lg font-bold text-slate-800 dark:text-white">Offsets & Repairs</h3>
					</div>
					<div className="grid gap-5 md:grid-cols-2">
						<CurrencyInput
			...
			<div className="lg:sticky lg:top-24">
				<div className="rounded-[1.8rem] border border-cyan-500/20 bg-[linear-gradient(180deg,rgba(14,165,233,0.06),rgba(2,6,23,0.02))] dark:bg-[linear-gradient(180deg,rgba(14,165,233,0.12),rgba(2,6,23,0.82))] p-6 shadow-lg">
					<p className="font-mono text-xs uppercase tracking-[0.24em] text-cyan-600 dark:text-cyan-400 font-semibold">
						Estimated Exposure
					</p>
					
					<div className="mt-4 mb-6">
						<h3 className="text-5xl font-black tracking-tight text-slate-850 dark:text-white">
					...
					<div className="grid gap-3.5">
						...
						<div className="flex justify-between items-center text-sm">
							<span className="text-emerald-600 dark:text-emerald-450">Security Deposit Offset</span>
						...
						<div className="mt-2 pt-3.5 border-t border-dashed border-slate-200 dark:border-slate-800 flex justify-between items-center">
							<span className="text-base font-bold text-slate-800 dark:text-white">Net Estimated Penalty</span>
					...
					<div className="mt-6 p-4 rounded-[1.2rem] bg-slate-50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-800/40">
